...
#ifndef SYBRIN_IOS_DOCUMENTSCANNER_SWIFT_H
#define SYBRIN_IOS_DOCUMENTSCANNER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Sybrin_iOS_DocumentScanner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC26Sybrin_iOS_DocumentScanner9DataModel")
...
SWIFT_CLASS("_TtC26Sybrin_iOS_DocumentScanner17DocumentDataModel")
@interface DocumentDataModel : DataModel
@property (nonatomic, readonly, copy) NSString * _Nullable rawData;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
///   </li>
/// </ol>
SWIFT_CLASS("_TtC26Sybrin_iOS_DocumentScanner22ImageScannerController")
